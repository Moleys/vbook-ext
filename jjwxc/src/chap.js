...
function execute(url) {
    ...
    console.log("http://app-cdn.jjwxc.net/androidapi/chapterContent?novelId="+novelid+"&chapterId="+chapterid)
    if (response.ok) {
        ...
        if(res_json.message){
            ...
            return Response.error(html1);
        }
        let chap_content = res_json.content.replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/\n　　/g,"<br>").replace(/<br><br>/g, "<br>");
